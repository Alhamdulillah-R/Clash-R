            ...
            return (
              <Grid size={1} key={item.name}>
                <Card
                  ...
                  sx={{
                    height: '100%',
                    // 跟 rex DetailPanel meta-card 同款: 整圈 1px outline-variant 边
                    // 状态色不再用左色条表达，状态完全靠下面的 chip 显示
                    borderRadius: '16px',
                    backgroundColor:
                    ...
                    '&:hover': {
                      ...
                      // hover 时整圈 border 变状态色 (像 rex fn-chip)
                    ...
                    // 入场动画：错峰让一组卡片有序浮入
                    animation: `card-float-in 0.32s cubic-bezier(0.16, 1, 0.3, 1) ${Math.min(idx * 18, 280)}ms both`,
                  }}
                >
                        ...
                        <span>
                          <Button
                            ...
                            sx={{
                              ...
                              height: 32,
                              padding: 0,
                              borderRadius: '999px', // pill / circle
                              '&:hover': {
                    ...
                    >
                      <Chip
                        ...
                        sx={{
                          ...
                          borderRadius: '8px',
                          fontWeight:
                            item.status === 'Pending' ? 'normal' : 600,
                          height: 26,
                        }}
                      />
